...
(function () {
   ...
   *  CHAVES E ESTADO
   * ------------------------------------------------------------------ */
  var DB_KEY = "edmakeup_admin_db_v1";
  var AUTH_KEY = "edmakeup_admin_auth_v1";
  ...
  var DEFAULT_DB = {
    ...
    categoriasProduto: ["Base", "Batom", "Sombra", "Máscara de cílios", "Pó e Blush", "Delineador", "Pincéis", "Skincare", "Perfumaria", "Acessórios"],
